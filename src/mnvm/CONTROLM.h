...
GLOBALPROC Keyboard_UpdateKeyMap(int key, blnr down)
{
...
#ifndef WantInitRunInBackground
...
LOCALVAR blnr MacMsgDisplayed = falseblnr;
...
LOCALPROC DrawCellsControlMessage(void)
{
...
LOCALPROC DrawControlMode(void)
{
	...
	DrawCellsFromStr(ControlMode2Str());
	DrawCellsEndLine();
